...
export const App = () => {
  return (
    <div className="flex flex-col place-items-center">
      ...
      <div className="grid xs:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xs:w-2/3 gap-2 place-items-center place-content-center p-2 ">
        ...
        <a href="https://jestjs.io/ru/"  target="_blank" rel="noopener noreferrer" className="logo text-white text-2xl" style={{width: 220, background: '#15c213'}}>
          JEST
        </a>
